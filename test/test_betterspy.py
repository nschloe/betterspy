...
def test_png():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        betterspy.write_png(M, filepath, border_width=1)
        im = imageio.imread(filepath)
        numpy.random.seed(123)
        ...
        betterspy.write_png(M, filepath, border_width=1, border_color='red')
        im = imageio.imread(filepath)
        ...
        betterspy.write_png(M, filepath, colormap='viridis')
        im = imageio.imread(filepath)
        ...
        betterspy.write_png(M, filepath, colormap='viridis', border_width=1)
        im = imageio.imread(filepath)
        y = numpy.random.randint(0, 100, size=22*32*3)
